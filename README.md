...
## Setup
The initial setup is recommended to prevent relative import errors and voids '''sys.path.insert()''' hacks. [See here](https://stackoverflow.com/questions/6323860/sibling-package-imports/50193944#50193944)
- Open terminal
